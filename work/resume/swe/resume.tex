...
\begin{resume_section}{Technical Skills}
  ...
  \textbf{Programming}  \= Python, Java, C++, JavaScript, PostgreSQL, Swift, Ruby\\*
  \textbf{ML Tools} \> AWS, PyTorch, Keras, TensorFlow\\*
  \textbf{Web} \> Django, Rails, Vue.js, React, Bootstrap\\*
