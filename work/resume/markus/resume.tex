...
\begin{resume_section}{Technical Skills}
  ...
  \textbf{Programming}  \= Python, Java, C++, JavaScript, PostgreSQL, Swift, Ruby, XML\\*
  \textbf{ML/Data} \> Jupyter Notebook, AWS, PyTorch, Keras, OpenCV, R\\*
...
\begin{resume_section}{Experience}
  \begin{resume_employer}{Bigtheta}{Project Leader (Remote)}{Toronto, ON}{May 2020 - Present}
    ...
    \item Presented the use of software development tools (e.g. use of git, Django basics).  
